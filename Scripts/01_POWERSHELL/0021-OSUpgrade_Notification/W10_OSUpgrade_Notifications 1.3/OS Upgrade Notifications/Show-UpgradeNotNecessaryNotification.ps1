# Script to display a custom message to the user that they are already running the targeted OS version.
...
$Content = "You are already running a newer version of Windows!"

# Display the message
New-WPFMessageBox -Content $Content -Title "Windows 10 Upgrade" -TitleFontSize 24 -TitleBackground Green -TitleTextForeground White -Sound 'Windows Notify'