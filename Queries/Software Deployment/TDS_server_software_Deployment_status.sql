...
JOIN v_FullCollectionMembership AS fcm on fcm.ResourceID = s1.ResourceID

where ae.AppEnforcementState is not null and aa.ApplicationName like '%flexnet%' ---'$ApplicationName'
and fcm.CollectionID = 'CAS0023A' -----CAS0023A HU, CAS00234   DE------all server E01006DD
