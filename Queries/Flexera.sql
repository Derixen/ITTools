...
VALUES 
('hubudmobfile'),('hubudqdspwfm'),('humscevh01333sv'),('humscevh01336sv'),('humscevh01977sv'),('humscevh01978sv'),('humscevh01981sv'),('humscevh01984sv'),('huszeevosmsrv'),('tfslog')
...
FROM  #temptable AS tmp
 ...
 LEFT JOIN (select sys.ResourceID, sys.Netbios_Name0, 
	...
	LEFT JOIN v_Add_Remove_Programs AS arp ON arp.resourceid = sys.resourceid and arp.DisplayName0 = 'FlexNet Inventory Agent'
